        ...
        >
          ...
          <footer className="mt-auto text-center py-6 bg-secondary text-secondary-foreground px-4"> {/* Added horizontal padding */}
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-4 mb-4 text-xs md:text-sm"> {/* Responsive layout and text size */}
              <a href="mailto:satyambro333@gmail.com" className="flex items-center text-secondary-foreground hover:text-primary transition duration-300 hover:opacity-80"> {/* Added hover effect */}
              ...
              <a href="tel:+917039201803" className="flex items-center text-secondary-foreground hover:text-primary transition duration-300 hover:opacity-80"> {/* Added hover effect */}
              ...
              <a
                  ...
                  aria-label="WhatsApp"
                  className="flex items-center text-secondary-foreground hover:text-primary transition duration-300 hover:opacity-80" // Added hover effect
                >
