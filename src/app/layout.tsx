...
export default function RootLayout({
  ...
  // Footer link groups
  const footerQuickLinks = navLinks.slice(0, 5); // Home, Notes, QP, Practicals, E-Books
                  ...
                  <ul className="flex space-x-6">
                    {navLinks.map((link) => (
                      <li key={link.href}>
                        <Link
                          href={link.href}
                          className="text-primary-foreground hover:opacity-80 transition-transform duration-300 transform hover:scale-110 inline-block" // Added hover scale animation
          ...
          <footer className="mt-auto py-8 bg-secondary text-secondary-foreground px-4">
             <div className="container mx-auto">
                   ...
                   <h3 className="text-lg font-semibold mb-3 text-primary">About Us</h3>
                    <ul className="space-y-2">
                     {footerSiteLinks.map((link) => (
                       ...
                       {/* Direct Contact Info */}
                       <li>
                         <a href="mailto:satyambro333@gmail.com" className="flex items-center text-sm hover:text-primary transition duration-300">
                           <Mail size={14} className="mr-1" />
                           satyambro333@gmail.com
                         </a>
                       </li>
                       <li>
                         <a href="tel:+917039201803" className="flex items-center text-sm hover:text-primary transition duration-300">
               ...
               <div className="border-t border-border pt-6 flex flex-col md:flex-row justify-between items-center">
                 <p className="text-xs md:text-sm mb-4 md:mb-0 text-muted-foreground">
                 ...
                 <div className="flex justify-center space-x-4">
                   <a
                     ...
                     className="text-secondary-foreground hover:text-primary transition-transform duration-300 transform hover:scale-110" // Added hover scale animation
                   >
