  ...
  return (
    ...
    <div className="container mx-auto py-12 fade-in-up">
      ...
      <section className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4">BCA</h1> {/* Updated heading */}
        <p className="text-lg text-muted-foreground">resource for quality education materials.</p> {/* Updated description */}
      </section>

      {/* Features Section */}
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* Notes Section Card - Added transition and hover effects */}
        <Card className="transition duration-300 ease-in-out hover:scale-105 hover:shadow-xl">
          <CardHeader>
        ...
        {/* Question Papers Archive Card - Added transition and hover effects */}
        <Card className="transition duration-300 ease-in-out hover:scale-105 hover:shadow-xl">
          <CardHeader>
        ...
        {/* Practicals Section Card - Added transition and hover effects */}
        <Card className="transition duration-300 ease-in-out hover:scale-105 hover:shadow-xl">
          <CardHeader>
        ...
        {/* About Section Card - Added transition and hover effects */}
        <Card className="transition duration-300 ease-in-out hover:scale-105 hover:shadow-xl">
          <CardHeader>
          ...
          <CardContent>
            <Link href="/about" className="text-teal-accent hover:underline font-medium">
              About us
            </Link>
          </CardContent>
        </Card>
